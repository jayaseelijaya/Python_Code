...
json_result = {
"Test Name" : "R4 Encounter Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 encounter resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 Encounter Resource API Test Case")
...
valid_r4_resource   = '639ea184-51d1-4e1c-8910-aa25a8c6fffc'

try:
    # Posting valid R4 Encounter resource 
    Encounter_url = r4_fhir_base_url + '/Encounter/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = Encounter_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 Encounter Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 Encounter Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 Encounter Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 encounter resource testing")
    json_result['Test Result'] = "Fail"
