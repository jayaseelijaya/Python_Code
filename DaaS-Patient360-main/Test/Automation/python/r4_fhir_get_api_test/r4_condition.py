...
json_result = {
"Test Name" : "R4 Condition Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 condition resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 Condition Resource API Test Case")
...
valid_r4_resource   = 'b885df8c-e437-4f19-8d01-140989da30a8'

try:
    # Posting valid R4 Condition resource 
    Condition_url = r4_fhir_base_url + '/Condition/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = Condition_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 Condition Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 Condition Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 Condition Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 condition resource testing")
    json_result['Test Result'] = "Fail"
