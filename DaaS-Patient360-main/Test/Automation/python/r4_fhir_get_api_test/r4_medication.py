...
json_result = {
"Test Name" : "R4 Medication Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 medication resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 Medication Resource API Test Case")
...
valid_r4_resource   = 'd1c48b62-0efc-11ed-9a67-2c8db1a15f90'

try:
    # Posting valid R4 Medication resource 
    Medication_url = r4_fhir_base_url + '/Medication/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = Medication_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 Medication Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 Medication Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 Medication Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 medication resource testing")
    json_result['Test Result'] = "Fail"
