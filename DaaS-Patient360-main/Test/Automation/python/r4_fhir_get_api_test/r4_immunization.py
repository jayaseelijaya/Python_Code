...
json_result = {
"Test Name" : "R4 Immunization Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 immunization resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 Immunization Resource API Test Case")
...
valid_r4_resource   = 'd1c3788a-0efc-11ed-bcb8-2c8db1a15f90'

try:
    # Posting valid R4 Immunization resource 
    Immunization_url = r4_fhir_base_url + '/Immunization/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = Immunization_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 Immunization Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 Immunization Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 Immunization Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 immunization resource testing")
    json_result['Test Result'] = "Fail"
