...
json_result = {
"Test Name" : "R4 MedicationStatement Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 medicationstatement resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 MedicationStatement Resource API Test Case")
...
valid_r4_resource   = 'd1c59a45-0efc-11ed-b1aa-2c8db1a15f90'

try:
    # Posting valid R4 MedicationStatement resource 
    MedicationStatement_url = r4_fhir_base_url + '/MedicationStatement/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = MedicationStatement_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 MedicationStatement Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 MedicationStatement Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 MedicationStatement Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 medicationstatement resource testing")
    json_result['Test Result'] = "Fail"
