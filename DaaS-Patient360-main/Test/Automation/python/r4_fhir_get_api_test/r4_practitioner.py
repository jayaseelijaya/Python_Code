...
json_result = {
"Test Name" : "R4 Practitioner Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 practitioner resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 Practitioner Resource API Test Case")
...
valid_r4_resource   = 'c0130bf9-13d4-11ed-ac7b-2c8db1a15f90'

try:
    # Posting valid R4 Practitioner resource 
    practitioner_url = r4_fhir_base_url + '/Practitioner/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = practitioner_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 Practitioner Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 Practitioner Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 Practitioner Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 practitioner resource testing")
    json_result['Test Result'] = "Fail"
