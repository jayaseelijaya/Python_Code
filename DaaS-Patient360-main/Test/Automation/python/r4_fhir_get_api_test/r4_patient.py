...
json_result = {
"Test Name" : "R4 Patient Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 patient resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 Patient Resource API Test Case")
...
valid_r4_resource   = 'a570b848-f5fa-11ec-86b6-a34af5e51290'

try:
    # Posting valid R4 Patient resource 
    Patient_url = r4_fhir_base_url + '/Patient/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = Patient_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 Patient Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 Patient Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 Patient Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 patient resource testing")
    json_result['Test Result'] = "Fail"
