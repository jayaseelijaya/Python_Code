...
json_result = {
"Test Name" : "R4 Organization Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 organization resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 Organization Resource API Test Case")
...
valid_r4_resource   = 'd37a4a7c-13d2-11ed-8907-2c8db1a15f90'

try:
    # Posting valid R4 Organization resource 
    Organization_url = r4_fhir_base_url + '/Organization/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = Organization_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 Organization Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 Organization Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 Organization Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 organization resource testing")
    json_result['Test Result'] = "Fail"
