...
json_result = {
"Test Name" : "R4 Observation Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 observation resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
print("Starting R4 Observation Resource API Test Case")
...
valid_r4_resource   = '645f49f6-33a3-4136-a435-f6b9099501b3'

try:
    # Posting valid R4 Observation resource 
    Observation_url = r4_fhir_base_url + '/Observation/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = Observation_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 Observation Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 Observation Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 Observation Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 observation resource testing")
    json_result['Test Result'] = "Fail"
