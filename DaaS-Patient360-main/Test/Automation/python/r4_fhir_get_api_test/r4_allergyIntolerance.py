...
json_result = {
"Test Name" : "R4 AllergyIntolerance Resource Test Case API. ",
"Test Discription" : "This test case is to verify positive working of R4 allergyIntolerance resource API. ",
"Test Result" : "",
"Start Time" : "",
"End Time" : "",
"Total Time" : ""
...
valid_r4_resource   = '49700427-9da2-4076-9c53-824224e20939'

try:
    # Posting valid R4 AllergyIntolerance resource 
    AllergyIntolerance_url = r4_fhir_base_url + '/AllergyIntolerance/' + valid_r4_resource
    fhir_response = requests.request(method = "GET", url = AllergyIntolerance_url, headers = r4_resource_header)
    if fhir_response.status_code == 200:
        ...
        if json_data['id'] == valid_r4_resource:
            print("R4 AllergyIntolerance Resource Testing Pass ")
            json_result['Test Result'] = "Pass"
        else:
            print("R4 AllergyIntolerance Resource Testing Failed")
            json_result['Test Result'] = "Fail"
    else:
        print("R4 AllergyIntolerance Resource Testing Failed")
        json_result['Test Result'] = "Fail"
except:
    print("Error occured at R4 allergyIntolerance resource testing")
    json_result['Test Result'] = "Fail"
