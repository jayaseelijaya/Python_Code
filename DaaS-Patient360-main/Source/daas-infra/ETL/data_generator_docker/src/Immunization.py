...
Immunization_folder = directory +'/Dataset/'
...
def immunization_resource(patient_newname,new_patient_id,Org_id):
     for Immunization in range(0,3):
        ...
        filename  = "Immunization"+str(Immunization)+ ".json"
        with open(Immunization_folder + filename, mode='w+', encoding='utf-8') as feedsjson:
