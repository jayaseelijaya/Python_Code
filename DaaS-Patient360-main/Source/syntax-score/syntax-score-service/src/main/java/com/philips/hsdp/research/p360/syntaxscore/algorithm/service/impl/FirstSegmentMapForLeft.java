...
/* @author Sunil Kumar */
public class FirstSegmentMapForLeft {
	 ...
	 * @return String: it will return (Segment): 1.0x5, that we can call in SelectedSegmentsProcessor.
	 */
	public String segmentsStringForMultiplyFive() {
		...
		segmentString = new HashMap<>();
		segmentString.put("1", "(Segment 1): 0x5 ");
		segmentString.put("2", "(Segment 2): 0x5 ");
		segmentString.put("3", "(Segment 3): 0x5 ");
		segmentString.put("5", "(Segment 5): 6x5 ");
		...
		segmentString.put("11", "(Segment 11): 2.5x5 ");
		segmentString.put("12", "(Segment 12): 1.0x5 ");
		segmentString.put("12a", "(Segment 12a): 1.0x5 ");
		segmentString.put("12b", "(Segment 12b): 1.0x5 ");
		segmentString.put("13", "(Segment 13): 1.5x5 ");
		segmentString.put("14", "(Segment 14): 1.0x5 ");
		segmentString.put("14a", "(Segment 14a): 1.0x5 ");
		segmentString.put("14b", "(Segment 14b): 1.0x5 ");
		segmentString.put("15", "(Segment 15): 1.0x5 ");
