...
class BridgingProcessorTest extends SyntaxScoreProcessor {
	@InjectMocks
	BridgingProcessor bridgingProcessor;
	...
	public void calculateSyntaxScoreLeftDominance() {
		bridgingProcessor.calculateSyntaxScoreLeftDominance();
	}

	@Test
	public void calculateSyntaxScoreRightDominance() {
		bridgingProcessor.calculateSyntaxScoreRightDominance();
	}
	...
	void processTestPositive() {
		when(syntaxScoreCodeableConceptCodeValue.isBridgingCollaterals()).thenReturn(true);
		when(syntaxScoreCodeableConceptCodeValue.isSelectedDominance()).thenReturn(true);
		bridgingProcessor.process();
	}
